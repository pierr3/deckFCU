export const AirbusGenericSvgDial = `<svg width="100%" height="100%" viewBox="0 0 200 100" version="1.1"
    ...
    <g id="spd" transform="matrix(1,0,0,1,-5.24295,-5.55525)" visibility="{{show_type_one}}">
        ...
        <text x="16px" y="30px" style="font-family:'B612Mono-Bold', 'B612 Mono', monospace;font-weight:700;font-size:22px;fill:rgb(209, 183, 77);">{{value_type_one}}</text>
    </g>
    ...
    <g id="inactive_dash" transform="matrix(1,0,0,1,9.53468,49.8578)" visibility="{{show_inactive}}">
        ...
        <text x="14.826px" y="28.706px" style="font-family:'Digital-7 Mono';font-size:58px;fill:rgb(209, 183, 77);">- - -</text>
    </g>
    <g id="inactive_circle" transform="matrix(0.986505,0,0,0.986505,3.25936,-0.177673)" visibility="{{show_dot}}">
        <circle cx="167.618" cy="58.864" r="12.671" style="fill:rgb(209, 183, 77);stroke:black;stroke-opacity:0;stroke-width:1.01px;"/>
    </g>
    <g id="active_speed" transform="matrix(1,0,0,1,22.3739,49.8578)" visibility="{{show_main_value}}">
        ...
        <text x="14.826px" y="28.706px" style="font-family:'Digital-7 Mono';font-size:58px;fill:rgb(209, 183, 77);">{{main_value}}</text>
    </g>
</svg>`;
